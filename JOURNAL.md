---
title: "extension_numpad"
author: "flo-lks"
description: "4x4 extension numpad"
...
I then wanted to add the rotary encoder, but when I wanted to update my PCB Editor it didn't recognize the connections from EC11SW_S1 and EC11SW_S2. After about half an hour, I realized that
the connections were not recognized because of a wrong footprint I assigned to the encoder.
